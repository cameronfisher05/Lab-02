...
author: "JohnnysBoys: Cameron Fisher, Finlay Webb, Edward Kimber"
date: "`r Sys.Date()`"
...
# Member 1 write code to load file 2 data here_:
...
plastic_data_all %>%  group_by(region) %>% count(sort = TRUE)
...
plastic_data_all %>% 
  ...
  summarise(mean_mismanaged_plastic = mean(total_mismanaged_plastic)) %>% 
  arrange(desc(mean_mismanaged_plastic))
